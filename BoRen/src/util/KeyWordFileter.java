...
import test.client.ClientTest;

public class KeyWordFileter {
	...
	private static void initPattern() {
		...
		try {
			// words.properties
			InputStream in = KeyWordFileter.class.getClassLoader()
	...
	private static int doFilter(String str) {
	...
	public static int keyWordStart(String keyWord){
		long startNumer = System.currentTimeMillis(); 
		initPattern();
		long endNumber = System.currentTimeMillis();  
		return doFilter(keyWord);
	}
