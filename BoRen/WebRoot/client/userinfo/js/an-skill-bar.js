"use strict";/*
				 * "use strict";/* Plugin: an-progress-bar Version: 1.0.1
				 * Description: A plugin that fills bars with a percentage you
				 * set. Author: Hasan Misbah Copyright 2018, Hasan Misbah Free
				 * to use and abuse under the MIT license.
